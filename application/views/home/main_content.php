<div style="background-color: #000;">
    <section class="hero is-fullheight" style="background: url('/static/img/main2.jpg') no-repeat center center; background-size: cover; background-attachment: fixed;">
...
<section class="hero is-small">
    <div class="hero-body">
        <div class="container">
            <h1 class="title">선인장은?</h1>
            <h2 class="subtitle">프로젝트 동아리</h2>
            <div class="content">
                <div class="columns">
                    <div class="column">
                        <h3 class="title">여러분의 열정을 보여 주세요</h3>
                        <h5 class="subtitle"></h5>
                    </div>
                    <div class="column">
                        <p>선인장은 겉으로 보기는 투박하고 뾰족뾰족한 가시 때문에 다소 정이 없어 보일 수도 있다. 하지만 선인장도 다른 풀이나 나무들처럼 꽃을 가지고 있다.<br>
                            척박한 환경에 뿌리 내리고, 모진 시련을 견디면서 피워낸 꽃,</p>
                        <p><b>어쩌면 선인장은 세상 그 어떤 풀나무들보다 아름다운 꽃을 피워내고 있을지도 모른다.</b></p>
                    </div>
                </div>
            </div>
        </div>
